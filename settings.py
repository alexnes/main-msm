...
LOG_FILENAME='/home/alex/python/main-msm/main-msm.log'
LOG_FORMAT=u'[%(asctime)s] %(levelname)-8s #%(filename)s[LINE:%(lineno)d]\t%(message)-65s '
...
LIB_PATH='/ZDOS/C/lib/'
ARCHIVE_DIFF_PATH='/home/alex/db/old/diff/'
ARCHIVE_INIT_PATH='/home/alex/db/old/init/'
DB_ARCHIVE_MAX_AGE=5
DIFF_ARCHIVE_MAX_AGE=10

INCOMING_PATH='/home/alex/db/incoming/'
